...
<section class="list">
    <div class="container panel">
        <div id="tree_search_box"><label>Поиск: </label><input id="tree_search" name="tree_search" type="text"  value="" /><a href="/cabinet/prod_cat.html?do=new">Добавить</a></div>
        <div id="tree_box">
...
<script type="text/javascript">
            ...
            "core" : {
                ...
                "data" : function(request, response){
                    $.ajax({
                        ...
                        type: "POST",
                        dataType: "json",
                        data: { file: "products_categories", token: $('#f_token').attr("content") },
    ...
    function category_edit(id) {
        window.location.href = "/cabinet/prod_cat/" + id + ".html";
    }
</script>