...
<section>
    ...
    <div class="container panel">
        ...
        <a href="/cabinet/look_cat.html">К списку категорий</a><br /><br />

        <form id="look_cat" name="look_cat" method="post">
...
<script type="text/javascript">
    $(function() {
        ...
        $("#save_category").on("click", function(e) {
            e.preventDefault();
            form_data = $("#look_cat").serialize();
            $.post("/_ajax.php", {token: $('#f_token').attr("content"), file: 'looks_categories_func', data: form_data}, function(r) {
                try {
                ...
                if (result.status == "success") {
                    if (typeof result.data.last_id !== 'undefined') {
                        window.location.href = "/cabinet/look_cat/" + result.data.last_id + ".html";
                    } else {
                        alert(result.mes);
                    }
                } else {
